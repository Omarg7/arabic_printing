...
class NetworkPrinter {
  ...
  void setStyles(PosStyles styles, {bool isArabic = false}) {
    _socket.add(_generator.setStyles(styles, isArabic: isArabic));
  }

  void rawBytes(List<int> cmd, {bool isArabic = false}) {
    _socket.add(_generator.rawBytes(cmd, isArabic: isArabic));
  }
  ...
  void imageBit(Image imgSrc, {PosAlign align = PosAlign.center}) {
    _socket.add(_generator.imageBit(imgSrc, align: align));
  }
